...
function LENS_Layout_DDEF()
    return dbc_container([
            ...
            dbc_row([
                    ...
                    dbc_col([
                            BASE_GlassPanel(["OPTIMISATION OBJECTIVES", html_span(" — Configure strict desirability criteria to algorithmically guide the rigorous search process.", className="ms-2 text-muted fw-normal", style=Dict("fontSize" => "0.65rem", "textTransform" => "none", "letterSpacing" => "0"))], [
                                    dbc_row(dbc_col([
                                            html_div(html_table([
                                                        html_thead(html_tr([
